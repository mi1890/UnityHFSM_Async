...
namespace FSM
{
	...
	public interface IAsyncStateMachine<TStateId>
    {
        void RequestStateChange(TStateId name, bool forceInstantly = false);
        AsyncStateBase<TStateId> ActiveState { get; }
    ...
    /// </summary>
    public class AsyncStateMachine<TOwnId, TStateId, TEvent> :
        AsyncStateBase<TOwnId>,
        ITriggerable<TEvent>,
        IAsyncStateMachine<TStateId>,
        IActionable<TEvent>
    {
        /// <summary>
        ...
        AsyncStateBase<TStateId> IAsyncStateMachine<TStateId>.ActiveState => throw new System.NotImplementedException();
        ...
        public AsyncStateMachine(bool isGhostState = false, bool isExitState = false)
        ...
        public void AddState(TStateId name, AsyncStateBase<TStateId> state)
        {
            state.fsm = this;
            state.name = name;
            state.Init();
        ...
        public AsyncStateBase<TStateId> GetState(TStateId name)
        {
            StateBundle bundle;
        ...
        public StateMachine<string, string, string> this[TStateId name]
        {
            get
            {
                AsyncStateBase<TStateId> state = GetState(name);
    ...
    public class AsyncStateMachine<TStateId, TEvent> : AsyncStateMachine<TStateId, TStateId, TEvent>
    {
        public AsyncStateMachine(bool isGhostState = false, bool isExitState = false)
            : base(isGhostState: isGhostState, isExitState: isExitState)
        {
    ...
    public class AsyncStateMachine<TStateId> : AsyncStateMachine<TStateId, TStateId, string>
    {
        public AsyncStateMachine(bool isGhostState = false, bool isExitState = false)
            : base(isGhostState: isGhostState, isExitState: isExitState)
        {
    ...
    public class AsyncStateMachine : AsyncStateMachine<string, string, string>
    {
        public AsyncStateMachine(bool isGhostState = false, bool isExitState = false)
            : base(isGhostState: isGhostState, isExitState: isExitState)
        {
